...
public class ExamScore extends BaseActivity implements TopBar.onTopClickedListener, ExpandableListView.OnChildClickListener {
    @ViewById(R.id.list)
...
//        mLv = mRefreshLv.getRefreshableView();
        ...
        cacheUtils = new CacheUtils(this, CacheUtils.CacheType.FOR_EXAM_RESULT);
        initData();
...
//        );
    ...
    private void refreshData() {
        ...
        new AsyncTask<String, String, String>() {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                statesUtils = new StatesUtils(ExamScore.this);
            ...
            protected String doInBackground(String... params) {
                ...
                try {
                    ...
                    URL tableUrl = new URL(
                            com.chillax.config.URL.bxqchengjiUrl);
    ...
    public class MyAdapter extends BaseExpandableListAdapter {
        ...
        public MyAdapter() {
            inflater = LayoutInflater.from(ExamScore.this);
    ...
    class ChildAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            com.chillax.softwareyard.adapter.ViewHolder holder = com.chillax.softwareyard.adapter.ViewHolder.get(ExamScore.this, convertView, android.R.layout.simple_list_item_1, position, null);
